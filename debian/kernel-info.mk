...
KERNEL_BOOTIMAGE_CMDLINE = bootopt=64S3,32N2,64N2 buildvariant=user console=tty0 droidian.lvm.prefer
...
DEVICE_FULL_NAME = POCO M4 Pro 5G
...
# Defconfig to use
KERNEL_DEFCONFIG = evergreen_defconfig
...
# will be made.
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/mediatek/evergreen.dtb
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/mediatek/evergreen.dtb
...
BUILD_PATH = /buildd/clang-r383902/bin:/buildd/los-4.9/bin:/buildd/los-4.9/los-arm/bin
